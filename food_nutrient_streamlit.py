...
st.sidebar.header("Food Nutrients")
## Put the logo image
img = 'nutrient.jpg'
...
st.title("Find Foods rich in some Nutrients")
...
with st.sidebar.beta_expander("*Data Sources*"):
     st.write(""" 
...
st.sidebar.markdown("By Danielle Taneyo")
